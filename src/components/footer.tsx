  ...
  return (
    <footer className="bg-[#9D143A] text-white font-light mx-auto">
      <div className="flex justify-center my-14">
        <div className="container grid grid-cols-1 sm:grid-cols-4 gap-6 p-10 text-center sm:text-left">
          ...
          <div>
            <h2 className="text-lg font-bold py-4">¿Qué es gob.mx?</h2>
            <p>Es el portal único de trámites, información y participación ciudadana. <a href="https://www.gob.mx/que-es-gobmx" className="text-blue-400 hover:text-blue-500">Leer más</a></p>
            <ul className="space-y-2">
          ...
          {/* Redes sociales */}
          <div>
            <h2 className="text-lg font-bold py-4">Síguenos en</h2>
